...
description: "Explains NWS Authentication Best Practices."
---
...
**Note:** Submitting requests without a User-Agent may result in a `403 Forbidden` error.
...
"http://api.weather.gov/points/43.1566,-77.6088
" on this server.
